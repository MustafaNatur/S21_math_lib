...
START_TEST(test_s21_math_ceil_usual) {
  ...
  ck_assert_ldouble_eq_tol(s21_ceil(testValue1), ceil(testValue1), 0.000001);
  ck_assert_ldouble_eq_tol(s21_ceil(testValue2), ceil(testValue2), 0.000001);
  ck_assert_ldouble_eq_tol(s21_ceil(testValue3), ceil(testValue3), 0.000001);
}
END_TEST
