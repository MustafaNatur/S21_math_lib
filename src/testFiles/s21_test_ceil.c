...
START_TEST(test_s21_math_ceil_usual) {
  ...
  ck_assert_ldouble_ne_tol(s21_ceil(testValue1), ceil(testValue1), 0);
  ck_assert_ldouble_ne_tol(s21_ceil(testValue2), ceil(testValue2), 0);
  ck_assert_ldouble_ne_tol(s21_ceil(testValue3), ceil(testValue3), 0);
}
END_TEST
