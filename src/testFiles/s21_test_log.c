...
START_TEST(test_s21_math_log_usual) {
  ...
  double testValue3 = 3;
  ck_assert_ldouble_eq_tol(s21_log(testValue1), log(testValue1), 0.000001);
  ck_assert_ldouble_eq_tol(s21_log(testValue2), log(testValue2), 0.000001);
  ck_assert_ldouble_eq_tol(s21_log(testValue3), log(testValue3), 0.000001);
