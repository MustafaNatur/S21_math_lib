...
double cases_pow_return_nan[][2] = {{0.00, NAN}, {POS_INF, NAN}, {NEG_INF, NAN}, {NAN, NAN}, {NAN, -NAN}, {-NAN, -NAN}, {0.00, -NAN}, {0.00, -NAN}, {-1.00, 1.50}, {-NAN, -NAN}};
double cases_pow_return_inf[][2] = {{0.00, -5.00}, {0.00, NEG_INF}, {0.10, NEG_INF}, {-0.10, NEG_INF}, {5.00, POS_INF}, {-5.00, POS_INF}, {POS_INF, 5.00}, {POS_INF, POS_INF}, {NEG_INF, POS_INF} };
double cases_pow_return_one[][2] ={{-1.00, POS_INF}, {-1.00, NEG_INF}, {1.00, NAN}, {1.00, POS_INF}, {1.00, 0.00}, {1.00, -5.00}, {1.00, 5.00}, {1.00, 1.50}, {-1.00, 2.00}, {NAN, 0.00}, {POS_INF, 0.00}, {5.00, 0.00}, {NEG_INF, 0.00}};
// pow(0.00, 5.00)->0.00 
