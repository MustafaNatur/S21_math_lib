...
START_TEST(test_s21_math_floor_usual) {
  ...
  ck_assert_ldouble_eq_tol(s21_floor(testValue1), floor(testValue1), 0.000001);
  ck_assert_ldouble_eq_tol(s21_floor(testValue2), floor(testValue2), 0.000001);
  ck_assert_ldouble_eq_tol(s21_floor(testValue3), floor(testValue3), 0.000001);
}
END_TEST
