...
START_TEST(test_s21_math_floor_usual) {
  ...
  ck_assert_double_eq(s21_floor(testValue1), floor(testValue1));
  ck_assert_double_eq(s21_floor(testValue2), floor(testValue2));
  ck_assert_double_eq(s21_floor(testValue3), floor(testValue3));
}
END_TEST
